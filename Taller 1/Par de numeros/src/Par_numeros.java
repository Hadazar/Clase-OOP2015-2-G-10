...
public class Par_numeros {
    ...
    public static void main(String[] args) {
      ...
      //Varibles de los números introducidos
       ...
       if ((numero_entero_1-(int)numero_entero_1 == 0) && (numero_entero_2-(int)numero_entero_2 == 0)){
    	 ...
    	 //Verificación de que el primer número es par o impar
          ...
          //Verificación de que el primer número es múltiplo del segundo
